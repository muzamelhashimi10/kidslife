...
<body>
    ...
    <?php
                    ...
                    if($one=="Amsterdam"){$count++;}
                    if($two=="Eiffel Tower and Paris"){$count++;}
                    if($three=="Belgium"){$count++;}
                    if($four=="Summer"){$count++;}
                    if($five=="Beautiful"){$count++;}
    ...
    ?>
        <div class="jumbotron text-center">
            ...
            <a href="../includes/english.php"><button type="button" class="btn btn-danger mt-3">Back To Course Page</button></a>
        </div>
