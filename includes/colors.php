        ...
        <div class="row">
            <div class="col-lg-8 col-md-7 col-12">
                ...
                <div class="container mt-4 mb-4" data-aos="fade-up">
                    ...
                    <div id="accordion">
                        <form action="../result/colour.php" method="post">
                            <div id="accordion">
                                ...
                                <div class="card mb-1">
                                    ...
                                    <div id="collapsetwo" class="collapse" data-parent="#accordion">
                                        <div class="question bg-white p-3 border-bottom">
                                            <div class="d-flex flex-row align-items-center question-title">
                                                <h3 class="text-danger">Q.</h3>
                                                <h5 class="mt-1 ml-2">What color is the sun ?</h5>
                                            </div>
                                            <div class="ans ml-2">
                                                <label class="radio"> <input type="radio" name="anstwo" value="Pink" required=""> <span>A) Pink</span>
                                                </label>
                                            </div>
                                            <div class="ans ml-2">
                                                <label class="radio"> <input type="radio" name="anstwo" value="Black with white stripes"> <span>B) Black with white stripes</span>
                                                </label>
                                            </div>
                                            <div class="ans ml-2">
                                                <label class="radio"> <input type="radio" name="anstwo" value="Yellow"> <span>C) Yellow</span>
                                                </label>
                                            </div>
                                            <div class="ans ml-2">
                                                <label class="radio"> <input type="radio" name="anstwo" value="None of the above"> <span>D) None of the above</span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card mb-1">
                                ...
                                <div id="collapsethree" class="collapse" data-parent="#accordion">
                                    <div class="question bg-white p-3 border-bottom">
                                        <div class="d-flex flex-row align-items-center question-title">
                                            <h3 class="text-danger">Q.</h3>
                                            <h5 class="mt-1 ml-2"> What color is Mr Joe's Black shoe ?</h5>
                                        </div>
                                        <div class="ans ml-2">
                                            <label class="radio"> <input type="radio" name="ansthree" value="orange"> <span>A) orange</span>
                                            </label>
                                        </div>
                                        <div class="ans ml-2">
                                            <label class="radio"> <input type="radio" name="ansthree" value="Black" required=""> <span>B) Black</span>
                                            </label>
                                        </div>
                                        <div class="ans ml-2">
                                            <label class="radio"> <input type="radio" name="ansthree" value="White"> <span>C) White</span>
                                            </label>
                                        </div>
                                        <div class="ans ml-2">
                                            <label class="radio"> <input type="radio" name="ansthree" value="Purple"> <span>D) Purple</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card mb-1">
                                ...
                                <div id="collapsefour" class="collapse" data-parent="#accordion">
                                    <div class="question bg-white p-3 border-bottom">
                                        <div class="d-flex flex-row align-items-center question-title">
                                            <h3 class="text-danger">Q.</h3>
                                            <h5 class="mt-1 ml-2"> What color is the police light?</h5>
                                        </div>
                                        <div class="ans ml-2">
                                            <label class="radio"> <input type="radio" name="ansfour" value="orange"> <span>A) orange</span>
                                            </label>
                                        </div>
                                        <div class="ans ml-2">
                                            <label class="radio"> <input type="radio" name="ansfour" value="Black" required=""> <span>B) Black</span>
                                            </label>
                                        </div>
                                        <div class="ans ml-2">
                                            <label class="radio"> <input type="radio" name="ansfour" value="White"> <span>C) White</span>
                                            </label>
                                        </div>
                                        <div class="ans ml-2">
                                            <label class="radio"> <input type="radio" name="ansfour" value="Blue"> <span>D) Blue</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card mb-1">
                                ...
                                <div id="collapsefive" class="collapse" data-parent="#accordion">
                                    <div class="question bg-white p-3 border-bottom">
                                        <div class="d-flex flex-row align-items-center question-title">
                                            <h3 class="text-danger">Q.</h3>
                                            <h5 class="mt-1 ml-2"> What color is Santa Claus Hair ?</h5>
                                        </div>
                                        <div class="ans ml-2">
                                            <label class="radio"> <input type="radio" name="ansfive" value="orange"> <span>A) orange</span>
                                            </label>
                                        </div>
                                        <div class="ans ml-2">
                                            <label class="radio"> <input type="radio" name="ansfive" value="Black" required=""> <span>B) Black</span>
                                            </label>
                                        </div>
                                        <div class="ans ml-2">
                                            <label class="radio"> <input type="radio" name="ansfive" value="White"> <span>C) White</span>
                                            </label>
                                        </div>
                                        <div class="ans ml-2">
                                            <label class="radio"> <input type="radio" name="ansfive" value="Purple"> <span>D) Purple</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
