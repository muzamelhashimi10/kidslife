        ...
        <div class="row">
            <div class="col-lg-8 col-md-7 col-12">
                <div class="mt-3 mb-3">
                    ...
                    <div class="mb-3">
                        <div id="carouselExampleIndicators" class="carousel slide mb-3" data-ride="carousel">
                            ...
                            <?php
                          		$show="select * from alphabatelecture";
                ...
                <div class="container mt-4 mb-4" data-aos="fade-up">
                    ...
                    <form action="../result/alphabet.php" method="post">
                        <div id="accordion">
                                ...
                                <div id="collapseOne" class="collapse" data-parent="#accordion">
                                    <div class="question bg-white p-3 border-bottom">
                                        <div class="d-flex flex-row align-items-center question-title">
                                            ...
                                            <img src="../images/pencil.png" width="200px" height="200" alt="">
                                        </div>
                                        <div class="ans ml-2">
                                            <label class="radio"> <input type="radio" name="ansone" value="Pencil" required=""> <span>Pencil</span>
                                            </label>
                                        </div>
                                        <div class="ans ml-2">
                                            <label class="radio"> <input type="radio" name="ansone" value="Pen"> <span>Pen</span>
                                            </label>
                                        </div>
                                        <div class="ans ml-2">
                                            <label class="radio"> <input type="radio" name="ansone" value="Chalk"> <span>Chalk</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card mb-1">
                                ...
                                <div id="collapsetwo" class="collapse" data-parent="#accordion">
                                    <div class="question bg-white p-3 border-bottom">
                                        <div class="d-flex flex-row align-items-center question-title">
                                            <h3 class="text-danger">Q.</h3>
                                            <img src="../images/ball.jpg" width="200px" height="200" alt="">
                                        </div>
                                        <div class="ans ml-2">
                                            <label class="radio"> <input type="radio" name="anstwo" value="Ball"> <span>Ball</span>
                                            </label>
                                        </div>
                                        <div class="ans ml-2">
                                            <label class="radio"> <input type="radio" name="anstwo" value="Bottle" required=""> <span>Bottle</span>
                                            </label>
                                        </div>
                                        <div class="ans ml-2">
                                            <label class="radio"> <input type="radio" name="anstwo" value="Broom"> <span>Broom</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card mb-1">
                            ...
                            <div id="collapsethree" class="collapse" data-parent="#accordion">
                                <div class="question bg-white p-3 border-bottom">
                                    <div class="d-flex flex-row align-items-center question-title">
                                        <h3 class="text-danger">Q.</h3>
                                        <img src="../images/shoe.jpg" width="200px" height="200" alt="">

                                    </div>
                                    <div class="ans ml-2">
                                        <label class="radio"> <input type="radio" name="ansthree" value="Sock"> <span>Sock</span>
                                        </label>
                                    </div>
                                    <div class="ans ml-2">
                                        <label class="radio"> <input type="radio" name="ansthree" value="Shoe" required=""> <span>Shoe</span>
                                        </label>
                                    </div>
                                    <div class="ans ml-2">
                                        <label class="radio"> <input type="radio" name="ansthree" value="Trouser"> <span>Trouser</span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card mb-1">
                            ...
                            <div id="collapsefour" class="collapse" data-parent="#accordion">
                                <div class="question bg-white p-3 border-bottom">
                                    <div class="d-flex flex-row align-items-center question-title">
                                        <h3 class="text-danger">Q.</h3>
                                        <img src="../images/car.jpg" width="200px" height="200" alt="">

                                    </div>
                                    <div class="ans ml-2">
                                        <label class="radio"> <input type="radio" name="ansfour" value="Boat" required=""> <span>Boat</span>
                                        </label>
                                    </div>
                                    <div class="ans ml-2">
                                        <label class="radio"> <input type="radio" name="ansfour" value="Plane"> <span>Plane</span>
                                        </label>
                                    </div>
                                    <div class="ans ml-2">
                                        <label class="radio"> <input type="radio" name="ansfour" value="Car"> <span>Car</span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card mb-1">
                            ...
                            <div id="collapsefive" class="collapse" data-parent="#accordion">
                                <div class="question bg-white p-3 border-bottom">
                                    <div class="d-flex flex-row align-items-center question-title">
                                        <h3 class="text-danger">Q.</h3>
                                        <img src="../images/house.jpg" width="200px" height="200" alt="">

                                    </div>
                                    <div class="ans ml-2">
                                        <label class="radio"> <input type="radio" name="ansfive" value="Phone"> <span>Phone</span>
                                        </label>
                                    </div>
                                    <div class="ans ml-2">
                                        <label class="radio"> <input type="radio" name="ansfive" value="House" required=""> <span>House</span>
                                        </label>
                                    </div>
                                    <div class="ans ml-2">
                                        <label class="radio"> <input type="radio" name="ansfive" value="Money"> <span>Money</span>
                                        </label>
                                    </div>
                                </div>
                            </div>
