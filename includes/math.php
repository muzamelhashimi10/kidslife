				...
				?>
                    ...
                    <div class="container mt-4 mb-4" data-aos="fade-up">
                        <div class="alert alert-danger alert-dismissible fade show">
                            ...
                            <strong>Here is your quesitons . <b>You Have To Answer All The Questions</b> ! </strong> All The Very Best To You .
                        </div>
                        <form action="../result/math.php" method="post">
                            <div id="accordion">
                                    ...
                                    <div id="collapseOne" class="collapse" data-parent="#accordion">
                                        <div class="question bg-white p-3 border-bottom">
                                            <div class="d-flex flex-row align-items-center question-title">
                                                ...
                                                <h5 class="mt-1 ml-2">2 + 3 ?</h5>
                                            </div>
                                            <div class="ans ml-2">
                                                <label class="radio"> <input type="radio" name="ansone" value="5" required=""> <span>5</span>
                                                </label>
                                            </div>
                                            <div class="ans ml-2">
                                                <label class="radio"> <input type="radio" name="ansone" value="2"> <span>2</span>
                                                </label>
                                            </div>
                                            <div class="ans ml-2">
                                                <label class="radio"> <input type="radio" name="ansone" value="3"> <span>3</span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card mb-1">
                                    ...
                                    <div id="collapsetwo" class="collapse" data-parent="#accordion">
                                        <div class="question bg-white p-3 border-bottom">
                                            <div class="d-flex flex-row align-items-center question-title">
                                                <h3 class="text-danger">Q.</h3>
                                                <h5 class="mt-1 ml-2">1 - 1 ?</h5>
                                            </div>
                                            <div class="ans ml-2">
                                                <label class="radio"> <input type="radio" name="anstwo" value="5"> <span>5</span>
                                                </label>
                                            </div>
                                            <div class="ans ml-2">
                                                <label class="radio"> <input type="radio" name="anstwo" value="0" required=""> <span>0</span>
                                                </label>
                                            </div>
                                            <div class="ans ml-2">
                                                <label class="radio"> <input type="radio" name="anstwo" value="2"> <span>2</span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card mb-1">
                                ...
                                <div id="collapsethree" class="collapse" data-parent="#accordion">
                                    <div class="question bg-white p-3 border-bottom">
                                        <div class="d-flex flex-row align-items-center question-title">
                                            <h3 class="text-danger">Q.</h3>
                                            <h5 class="mt-1 ml-2"> 5 -3 ?</h5>
                                        </div>
                                        <div class="ans ml-2">
                                            <label class="radio"> <input type="radio" name="ansthree" value="5"> <span>5</span>
                                            </label>
                                        </div>
                                        <div class="ans ml-2">
                                            <label class="radio"> <input type="radio" name="ansthree" value="2" required=""> <span>2</span>
                                            </label>
                                        </div>
                                        <div class="ans ml-2">
                                            <label class="radio"> <input type="radio" name="ansthree" value="8"> <span>8</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card mb-1">
                                ...
                                <div id="collapsefour" class="collapse" data-parent="#accordion">
                                    <div class="question bg-white p-3 border-bottom">
                                        <div class="d-flex flex-row align-items-center question-title">
                                            <h3 class="text-danger">Q.</h3>
                                            <h5 class="mt-1 ml-2"> 6 * 1 ?</h5>
                                        </div>
                                        <div class="ans ml-2">
                                            <label class="radio"> <input type="radio" name="ansfour" value="6" required=""> <span>6</span>
                                            </label>
                                        </div>
                                        <div class="ans ml-2">
                                            <label class="radio"> <input type="radio" name="ansfour" value="5"> <span>5</span>
                                            </label>
                                        </div>
                                        <div class="ans ml-2">
                                            <label class="radio"> <input type="radio" name="ansfour" value="3"> <span>3</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card mb-1">
                                ...
                                <div id="collapsefive" class="collapse" data-parent="#accordion">
                                    <div class="question bg-white p-3 border-bottom">
                                        <div class="d-flex flex-row align-items-center question-title">
                                            <h3 class="text-danger">Q.</h3>
                                            <h5 class="mt-1 ml-2"> 8 / 4 ?</h5>
                                        </div>
                                        <div class="ans ml-2">
                                            <label class="radio"> <input type="radio" name="ansfive" value="5"> <span>5</span>
                                            </label>
                                        </div>
                                        <div class="ans ml-2">
                                            <label class="radio"> <input type="radio" name="ansfive" value="2" required=""> <span>2</span>
                                            </label>
                                        </div>
                                        <div class="ans ml-2">
                                            <label class="radio"> <input type="radio" name="ansfive" value="3"> <span>3</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
